...
public class TestTree {
    ...
    public void testDomainTree(){
        List<GroupInfo> domains = Arrays.asList(
                new GroupInfo("mya.com","11","a.com"),
                new GroupInfo("mycom","11","com"),
                new GroupInfo("组1-2","12","sina.com.cn"),
                new GroupInfo("zzq","1","zzq3.zzq2.zzq1"),
                new GroupInfo("aaa","1","a"),
                new GroupInfo(",,,","3",","),
                new GroupInfo("xxx","1","."),
                new GroupInfo("腾讯","1","www.qq.com"),
                new GroupInfo("腾讯2","1","www.qq2.com"),
                new GroupInfo("腾讯3","1","www.qq3.com"),
                new GroupInfo("大百度","1","www.baidu.com"),
                new GroupInfo("百度1","233","*.gccdn.net"),
//                //情况1  泛域名在最后
